...
const filters = [
  ...
  {
    id: "capacity",
    name: "Washer Dryer Combination Capacity",
    options: [
      { value: "6kg", label: "Up to 6 kg" },
      { value: "8kg", label: "6 - 8 kg" },
      { value: "10kg", label: "8 - 10 kg" },
      { value: "12kg", label: "Above 10 kg" },
    ],
  },
  {
    ...
    options: [
      ...
      { value: "1000rpm", label: "800 - 1000 RPM" },
