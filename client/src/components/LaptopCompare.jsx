      ...
      >
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Screen Size</td>
            {compareList.map((product) => (
              <td key={product._id}>{product.screenSize}</td>
            ))}
          </tr>
          <tr>
            <td colSpan={1}></td>
            ...
            {compareList.map((product) => (
              <td key={product._id}>{product.hardDiskSize}</td>
            ))}
          </tr>
          <tr>
            <td colSpan={1}></td>
            <td>CPU Model</td>
            {compareList.map((product) => (
              <td key={product._id}>{product.cpuModel}</td>
            ))}
          </tr>
          <tr>
            <td colSpan={1}></td>
            <td>RAM Size</td>
            {compareList.map((product) => (
              <td key={product._id}>{product.ramMemoryInstalledSize}</td>
            ))}
          </tr>
          <tr>
            <td colSpan={1}></td>
          ...
          <tr>
            ...
            <td>Graphics Card</td>
            {compareList.map((product) => (
              <td key={product._id}>{product.graphicsCardDescription}</td>
            ))}
          </tr>
          <tr>
            <td colSpan={1}></td>
