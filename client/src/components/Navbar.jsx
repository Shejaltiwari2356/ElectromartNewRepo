...
export const Navbar = () => {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    if (searchQuery.trim()) {
      // Logic to determine which category to navigate to
      const lowerQuery = searchQuery.toLowerCase();
      let category = "";

      // Basic keyword matching for categories
      if (lowerQuery.includes("mac") || lowerQuery.includes("laptop")) {
        category = "laptops";
      } else if (
        ...
        lowerQuery.includes("ac") ||
        lowerQuery.includes("air conditioner")
      ) {
        category = "ac";
      } else {
        category = "search"; // Default to a general search
      }
